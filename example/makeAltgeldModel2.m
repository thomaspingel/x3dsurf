...
O = lasread('../data/DK22.las');

%%

S = shaperead('altgeld.shp');
% bb = S.BoundingBox;
% bb = [866869 1918967; 867290 1919305]; % Altgeld
bb = [866550 1917500; 868700 1919700]; % Altgeld
...
cellSize = 2; 
% cellSize = cellSize * modelScale;
[I R] = createDSM(X,Y,Z,'c',cellSize,'inpaintmethod',4,'type','min');

bad = progressiveFilter(I,'c',cellSize,'w',2','s',.15);
I(bad) = NaN;
I = inpaint_nans(I,5);
...
x3dindexedfaceset2('altgeld.x3d',idx,x,y,z,'solid','false','convex','false','precision',8,...
